...
- License validation and device binding for desktop and web clients
- Stripe subscription hooks for `free`, `pro`, and `elite` plans
...
## License & Subscription APIs

- `GET /api/license/plans`
- `GET /api/license/me`
- `POST /api/license/issue`
- `POST /api/license/validate`
- `POST /api/license/checkout-session`
