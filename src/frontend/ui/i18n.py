...
TRANSLATIONS = {
    "app.window_title": {
        "en": "Sopotek Trading AI",
        "fr": "Sopotek Trading AI",
        "es": "Sopotek Trading AI",
        "pt": "Sopotek Trading AI",
    },
    "dashboard.window_title": {
        "en": "Sopotek AI Trading Platform",
        "fr": "Plateforme de Trading IA Sopotek",
        "es": "Plataforma de Trading IA Sopotek",
        "pt": "Plataforma de Trading IA Sopotek",
    },
    ...
    "dashboard.hero_title": {
        "en": "Design a dashboard that feels ready before you even press connect.",
        "fr": "Un tableau de bord pret avant meme de vous connecter.",
        "es": "Un panel que se siente listo antes de conectar.",
        "pt": "Um painel que parece pronto antes mesmo de conectar.",
    },
    "dashboard.hero_lead": {
        "en": "This launch screen should help you scan the broker, strategy, and risk posture in seconds.",
        "fr": "Cet ecran doit vous aider a verifier le broker, la strategie et le risque en quelques secondes.",
        "es": "Esta pantalla debe ayudarte a revisar broker, estrategia y riesgo en segundos.",
        "pt": "Esta tela deve ajudar voce a revisar broker, estrategia e risco em segundos.",
    },
    ...
    "dashboard.desk_snapshot_body": {
        "en": "Use the dashboard like a pre-flight panel: confirm broker type, strategy posture, and credentials before the terminal takes over.",
        "fr": "Utilisez ce tableau de bord comme un panneau de verification avant le terminal.",
        "es": "Usa este panel como verificacion previa antes del terminal.",
        "pt": "Use este painel como verificacao previa antes do terminal.",
    },
    ...
    "dashboard.check_strategy_title": {
        "en": "Strategy plan",
        "fr": "Plan strategie",
        "es": "Plan de estrategia",
        "pt": "Plano de estrategia",
    },
    ...
    "dashboard.design_title": {
        "en": "What better design means here",
        "fr": "Ce que signifie un meilleur design ici",
        "es": "Lo que significa un mejor diseno aqui",
        "pt": "O que significa um design melhor aqui",
    },
    "dashboard.design_bullet_1": {
        "en": "Big decisions are obvious at a glance.",
        "fr": "Les grandes decisions sont visibles d'un coup d'oeil.",
        "es": "Las decisiones importantes se ven de inmediato.",
        "pt": "As decisoes importantes ficam claras de imediato.",
    },
    "dashboard.design_bullet_2": {
        "en": "Optional broker fields only appear when they matter.",
        "fr": "Les champs optionnels n'apparaissent que lorsqu'ils comptent.",
        "es": "Los campos opcionales solo aparecen cuando importan.",
        "pt": "Os campos opcionais aparecem apenas quando importam.",
    },
    "dashboard.design_bullet_3": {
        "en": "The screen still breathes on smaller windows.",
        "fr": "L'ecran reste lisible sur des fenetres plus petites.",
        "es": "La pantalla sigue siendo clara en ventanas pequenas.",
        "pt": "A tela continua clara em janelas menores.",
    },
    "dashboard.design_bullet_4": {
        "en": "Paper and live sessions feel clearly different.",
        "fr": "Les sessions paper et live restent clairement distinctes.",
        "es": "Las sesiones paper y live se sienten claramente distintas.",
        "pt": "As sessoes paper e live ficam claramente distintas.",
    },
    ...
    "terminal.window_title": {
        "en": "Sopotek AI Trading Terminal",
        "fr": "Terminal de Trading IA Sopotek",
        "es": "Terminal de Trading IA Sopotek",
    ...
    "terminal.menu.data": {"en": "Data", "fr": "Donnees", "es": "Datos", "pt": "Dados"},
    "terminal.menu.settings": {"en": "Settings", "fr": "Parametres", "es": "Configuracion", "pt": "Configuracoes"},
    "terminal.menu.language": {"en": "Language", "fr": "Langue", "es": "Idioma", "pt": "Idioma"},
    "terminal.menu.tools": {"en": "Tools", "fr": "Outils", "es": "Herramientas", "pt": "Ferramentas"},
