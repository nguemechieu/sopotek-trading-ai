...
$desktopEntryPoint = Join-Path $desktopRoot "main.py"
$vendoredPythonPaths = @(
...
$process = Start-Process `
    ...
    -ArgumentList @($selected.Arguments + @($desktopEntryPoint)) `
...
if ($process.HasExited) {
    Write-Host "Sopotek Trading AI desktop exited during startup. Recent stderr:"
...
Write-Host "Sopotek Trading AI desktop launched with $($selected.Name)."
